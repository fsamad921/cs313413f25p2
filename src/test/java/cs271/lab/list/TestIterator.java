...
public class TestIterator {
  ...
  public void setUp() throws Exception {
    ...
    // TODO Question: Also try with a LinkedList - does it make any difference? (DONE)
  }
  ...
  public void testNonempty() {
    ...
    // TODO fix the expected values in the assertions below (DDNE)
    assertTrue(i.hasNext());
  ...
  public void testRemove() {
    ...
    while (i.hasNext()) {
      if (i.next() == 77) {
        i.remove(); // TODO Question: What happens if you use list.remove(Integer.valueOf(77))? (DONE)
          // list.remove(Integer.valueOf(77)); Throws exception
      }
    }
